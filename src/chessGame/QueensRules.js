...
const QueensRules = () => (
  ...
  <br/> Dès qu'elles entrent en conflit, les cases se bordent de rouge.
   ...
   <p> Is it possible to place 8 queens on the chessboard without them conflicting?
   ...
   </p><p> The chessboard is coded with React.
   </p><p>  To answer my friend Fred who exposed me the idea, and check that the code was written in an scalable way, I extended the game to bishops, rocks and knights.
   </p>
  </div>
)
